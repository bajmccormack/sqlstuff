...
-- What has been hurting us in the last 5 seconds. Look for wait stats, and anything out of the plan cache has been recently erased.
...
/*	Some other things to consider
	...
	Are any non SQL processes using CPU
